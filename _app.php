<div id="sidebar">
    <div id="form_con">
           <h3>Office Hours:<br>Monday: 10am to 8pm<br>Tues - Thurs: 8am to 5pm</h3>
                ...
                <form id="form1" name="form1" method="post" action="app_send.php">
                    ...
                    <div id="form_label"><label for="desc"></label><textarea id="form_label" placeholder="Comments" name="desc" cols="25" rows="5" id="desc" class="form-control"></textarea></div>

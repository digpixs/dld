...
<div class="header_hp">
    <div class="header_hp_con">
        <div class="header_img"></div>
        <div id="dld_num_hp"><h4>Office: 856-875-8400<br>Emergency: 609-221-2964</h4></div>
        <div id="carousel">
            <div id="slideshow">
            <div><img src="img/hp_ban_white_teeth.jpg" alt="welcome to dayspring"></div>
            <div><img src="img/hp_ban_boy.jpg" alt="boy brushing teeth"></div>
            <div><img src="img/hp_ban_mom_child.jpg" alt="mother and child"></div>
            <div><img src="img/hp_ban_kids.jpg" alt="relaxed stress free environment"></div>
            <div><img src="img/hp_ban_flossing.jpg" alt="woman flossing"></div>
            <div><img src="img/hp_ban_instru.jpg" alt="personal service indivual attention"></div>
            </div>
        </div>
    </div>
</div>
...
<div id="page_info">
    <div id="hp_greet">
    <h1>Meet the Docs - Dayspring Laser Dentistry</a></h1>
